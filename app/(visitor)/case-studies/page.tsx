...
import { caseStudies, CaseStudy } from '@/constants/mockData/caseStudiesData';
...
// import { Testimonials } from '@/components/techStack.component';
        ...
        <div className="max-w-7xl mx-auto px-6 lg:px-8">
            ...
            <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
                {filteredStudies.map((study) => (
                    <Link key={study.id} href={`/case-studies/${study.id}`} className="group block h-full">
