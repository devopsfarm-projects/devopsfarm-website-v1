      ...
      <div className="max-w-7xl mx-auto px-6 lg:px-8">
        ...
        <div className="flex flex-col md:flex-row justify-between items-end mb-12 relative">
            ...
            <div className="flex items-center gap-6 mt-6 md:mt-0 z-10">
                ...
                <Link to="/case-studies" className="hidden md:flex flex-col items-center justify-center w-24 h-24 rounded-full bg-navy-50 border border-navy-100 hover:bg-navy-900 hover:text-white hover:border-navy-900 transition-all duration-300 group shadow-sm">
        ...
        >
            {caseStudies.map((item) => (
                ...
                >
                    <Link to={`/case-studies/${item.id}`} className="block h-full">
            ...
            <div className="min-w-[100px] flex items-center justify-center md:hidden">
                 <Link to="/case-studies" className="w-16 h-16 rounded-full bg-navy-50 flex flex-col items-center justify-center border border-navy-100 text-brand">
