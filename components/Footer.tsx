            ...
            <div>
              ...
              <ul className="space-y-4">
                {footer.services.map((item) => (
                    <li key={item.name}>
                        <Link to={item.href} className="text-gray-600 hover:text-brand transition-colors block text-sm font-medium hover:translate-x-1 transform duration-200">
                            {item.name}
                        </Link>
                    </li>
                ))}
            ...
            <div>
              ...
              <ul className="space-y-4">
                {footer.company.map((item) => (
                  <li key={item.name}>
                    <Link to={item.href} className="text-gray-600 hover:text-brand transition-colors block text-sm font-medium hover:translate-x-1 transform duration-200 flex items-center gap-2 group">
                      {item.name}
                      {item.badge && (
          ...
          <div className="flex gap-8">
            {footer.legal.map((item) => (
              item.href.startsWith('/') ? (
                <Link key={item.name} to={item.href} className="hover:text-navy-900 transition-colors font-medium hover:underline decoration-brand decoration-2 underline-offset-4">{item.name}</Link>
              ) : (
