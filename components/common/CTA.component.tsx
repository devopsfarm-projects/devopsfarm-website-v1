    ...
    <section className="py-10 md:py-14 bg-navy-900 relative overflow-hidden">
      ...
      <div className="max-w-5xl mx-auto px-6 lg:px-8 text-center relative z-10">
        ...
        <h3 className="text-3xl md:text-4xl lg:text-5xl font-bold text-white mb-5 tracking-tight leading-tight">
          ...
          that <span className="text-brand bg-clip-text bg-gradient-to-r from-brand-light to-white">Deliver Measurable Results</span>
        </h3>
        ...
        <Link href="/contact">
          <Button
            size="lg"
            className="!bg-violet-600 hover:!bg-red-500 text-white border-0 shadow-lg shadow-violet-500/30 hover:shadow-red-500/30 text-base md:text-lg px-8 py-3 md:px-10 md:py-4 group font-extrabold uppercase tracking-wide transition-all"
          >
            Get Free Risk Assessment
            <ArrowRight className="ml-2 w-5 h-5 stroke-white group-hover:translate-x-1 transition-transform" />
          </Button>
